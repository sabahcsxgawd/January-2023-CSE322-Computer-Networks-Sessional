...
gnuplot -c "scratch/1905118_plot_jain_plr.sh" "scratch/1905118_jain_pktLossRate_$alg2"_"$alg1.png" "scratch/1905118_thrpt_pktLossRate_$alg2"_"$alg1.dat" "$alg2" "$alg1"